...
class Manager extends Component
{
    ...
    {
        return view('views.elecciones-v2.manager');
    }
    ...
    public function updateTerminal($id)
    {
        ...
        if ((bool)$control->getATerminal()) {
            return redirect()->route('elecciones-v2.gestion')->with('terminal', $control->terminal->user_name);
        } else {
    ...
    public function releaseTerminal($id)
    {
        ...
        return redirect()->route('elecciones-v2.gestion')->with('success', 'Terminal liberado');
    }
