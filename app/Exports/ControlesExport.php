...
class ControlesExport implements FromArray,WithHeadings,WithStyles
{
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle(['1','1','5','1000'])->getAlignment()->setVertical('top')->setWrapText(true);
        $sheet->getStyle(['3','1','5','1000'])->getAlignment()->setVertical('center');
