<div>
    ...
    <div class="card mt-0 mx-3">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a class="btn btn-primary " href="{{ route('predio.export.controles') }}">Exportar EXCEL Predios</a>
        </div>
        <div class="card-body">
            <div class="row g-3">
                <div class="col-6">
                    <div class="card">
                        <form action="{{ route('asamblea.update') }}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" class="form-control fs-5 "
                                        value="{{ $asambleaa->referencia }}" name="referencia">
                                </div>
                                <div class="input-group mb-2">
                                    <span class="input-group-text">
                                        Tipo:
                                    ...
                                    <input type="number" class="form-control fs-5 " value="{{ $asambleaa->controles }}"
                                        name="controles" oninput="debouncedValidateMultipleOf50(this)" max="800"
                                        required>
                                </div>
                                <div class="input-group mb-2">
                                    <span class="input-group-text">
                            ...
                            @if ($asambleaa->controles > 400)
                                <div class="card-footer d-flex  align-items-center">
                                    <small class="mb-0 me-2" style="white-space: nowrap">Dispositivo #0</small>
                                    <input type="text" class="form-control form-control-sm me-2"  name="device0" id="device0Input" 
                                    wire:model='device0' placeholder="Serial del dispositivo HID" readonly>
                                    <small class="mb-0 me-2" style="white-space: nowrap">Dispositivo #1</small>
                                    <select name="device1" id="device1Select" class="form-control form-control-sm me-2"
                                    wire:model.live="device1" >
                                        <option value="" selected>Seleccionar dispositivo</option>
                                        @foreach ($devicesHid as $device)
                                            <option value="{{ $device }}">
                                                {{ $device }}
                                            </option>
                                        @endforeach
