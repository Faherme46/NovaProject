<div>
    ...
    <div class="row g-3">
        <div class="col-7">
            <div class="card">
                <form action="{{ route('elecciones-v2.update') }}" method="POST">
                    @csrf
            ...
            <div class="card">
                <div class="card-body px-0">
                    ...
                    <div class="row justify-content-center px-4 mt-3">
                        ...
                        <form action="{{ route('elecciones-v2.report.create') }}" method="GET" id="formReport"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Â¿Desea cerrar la asamblea actual?</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    Se descargarÃ¡ toda la informacion de la asamblea en las carpetas correspondientes
