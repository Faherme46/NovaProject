        ...
        <div class="col-7">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="/elecciones-v2-v2/terminales" class="btn btn-primary">Actualizar</a>
                </div>
                <div class="card-body p-0">
                    <table class="table table-striped mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="7">NO HAY TERMINALES EN SESIÃ“N</td>
                                </tr>
                            @endforelse
                        </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="staticBackdropLabel">Â¿Desea cerrar esta sesiÃ³n de terminal?</h1>
