                ...
                <form class="row g-3" id="asamblea-form" action="{{ route('asambleas.store') }}" method="POST">
                    ...
                    <div class="form-group text-center">
                        <div class="btn-group" role="group">
                            <input type="radio" class="btn-check" name="registro" id="registro1" value="true" checked>
                            <label class="btn btn-outline-primary" for="registro1">Registro</label>

                            <input type="radio" class="btn-check" name="registro" id="registro2" value="false" >
                            <label class="btn btn-outline-primary" for="registro2">Solo votacion</label>
                        </div>
